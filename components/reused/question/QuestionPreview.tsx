...
const QuestionPreview = () => {
  const TMPTEXT =
    "Lörem ipsum triren tirat. Dekasade tes utan nitest sedan semin dijugt. Spehonat mikronygisk, pelosm. " +
  ...
  return (
    <div className={styles.preview}>
      ...
      <div className={styles.previewHeader2}>질문 제목을 입력하세요</div>
      <div className={styles.previewBody}>{TMPTEXT}</div>
    </div>
  );
};
